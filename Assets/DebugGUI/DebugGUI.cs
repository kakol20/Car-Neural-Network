...
public class DebugGUI : MonoBehaviour
{
    ...
    [SerializeField] private bool drawInBuild = false;
    ...
    [SerializeField] private List<GraphContainer> graphs = new List<GraphContainer>();
    ...
    { get { return Instance.displayLogs && (Instance.drawInBuild || Application.isEditor); } }
    private static bool GraphsEnabled
    { get { return Instance.displayGraphs && (Instance.drawInBuild || Application.isEditor); } }
    ...
    private class GraphContainer
    {
        ...
        private static readonly Color32[] clearColorArray = new Color32[graphWidth * graphHeight];
